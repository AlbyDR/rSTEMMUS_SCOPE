...
change_STEMMUS_ModelSettings <- function(
  ...
  Settings <- c(
    ...
    paste0("    ModelSettings.Eqlspace = ", 0, "; % Indicator for deciding is the space step equal or not; % the DeltZ would be reset in 50cm by hand;"),
    "",
...
change_STEMMUS_DefineConstants <- function(
    ...
    R = "8.314",
    R_specific = "0.287",
    rhoa = "1.2047", kappa = "0.4", MH2O = "18", Mair = "28.96", MCO2 = "44", sigmaSB = "5.67E-8", deg2rad = "pi / 180",
    C2K = "273.15", CKTN = "(50 + 2.575 * 20)", l = "0.5", g = "981", RHOL =  "1", RHOI = "0.92",Rv = "461.5 * 1e4",
    RDA = "287.1 * 1e4", RHO_bulk = "1.25", Hc = "0.02", GWT = "7", MU_a = "1.846 * 10^(-4)", Gamma0 = "71.89",
    Gamma_w = "const.RHOL*const.g",  Lambda1 = "0.228 / 100", Lambda2 = "-2.406/100", Lambda3 =  "4.909/100",
    MU_W0 = "2.4152 * 10^(-4)", MU1 = "4742.8", b = "4 * 10^(-6)", W0 = "1.001 * 10^3", c_L = "4.186", c_V = "1.870",
    c_a = "1.005", c_i = "2.0455", lambdav = "2.45", k = "0.41"
